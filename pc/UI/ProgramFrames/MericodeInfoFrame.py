...
class MericodeInfo(customtkinter.CTkFrame):
    def __init__(self, parent, frameParent, *args, **kwargs):
        ...
        self.linesText.grid(row=1, column=0, sticky=tkinter.NW, columnspan=1, padx=(5, 0))
        ...
        self.linesText.grid(row=7, column=0, sticky=tkinter.NW, columnspan=1, padx=(5, 0))

        self.lineColorText = customtkinter.CTkLabel(master=self, text="Arc", text_color=Colors.TEXT, font=("", 11), anchor=tkinter.W)
        self.lineColorText.grid(row=7, column=1, sticky=tkinter.NW, columnspan=1, padx=(5, 0))
